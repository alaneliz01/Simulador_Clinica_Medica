...
def _obtener_datos_paciente(df):
    ...
    datos["Edad"] = _input_validado("Edad: ", int, lambda x: 0 < x < 130, "Edad no válida.")
    ...
    datos["Estatura"] = _input_validado("Estatura (cm): ", float, lambda x: 1.20 < x < 2.50, "Estatura fuera de rango.")
